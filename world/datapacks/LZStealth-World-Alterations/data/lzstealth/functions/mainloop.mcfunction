...
execute as @e[type=zombie_villager,scores={MobHeadDrops=1,MobHeadDrops=1..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:zombie_villager/farmer"}
execute as @e[type=zombie_villager,scores={MobHeadDrops=2,MobHeadDrops=2..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:zombie_villager/librarian"}
execute as @e[type=zombie_villager,scores={MobHeadDrops=3,MobHeadDrops=3..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:zombie_villager/cleric"}
execute as @e[type=zombie_villager,scores={MobHeadDrops=4,MobHeadDrops=4..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:zombie_villager/smith"}
execute as @e[type=zombie_villager,scores={MobHeadDrops=5,MobHeadDrops=5..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:zombie_villager/butcher"}
execute as @e[type=zombie_villager,scores={MobHeadDrops=6,MobHeadDrops=6..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:zombie_villager/nitwit"}
execute as @e[type=llama,scores={MobHeadDrops=7,MobHeadDrops=7..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:llama/creamy"}
execute as @e[type=llama,scores={MobHeadDrops=8,MobHeadDrops=8..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:llama/white"}
execute as @e[type=llama,scores={MobHeadDrops=9,MobHeadDrops=9..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:llama/brown"}
execute as @e[type=llama,scores={MobHeadDrops=10,MobHeadDrops=10..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:llama/gray"}
execute as @e[type=ocelot,scores={MobHeadDrops=11,MobHeadDrops=11..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:cats/ocelot"}
execute as @e[type=ocelot,scores={MobHeadDrops=12,MobHeadDrops=12..},tag=!loot1] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot1"],DeathLootTable:"mobs:cats/black"}
execute as @e[type=ocelot,scores={MobHeadDrops=13,MobHeadDrops=13..},tag=!loot1] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot1"],DeathLootTable:"mobs:cats/ginger"}
execute as @e[type=ocelot,scores={MobHeadDrops=14,MobHeadDrops=14..},tag=!loot1] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot1"],DeathLootTable:"mobs:cats/siamese"}
execute as @e[type=rabbit,scores={MobHeadDrops=15,MobHeadDrops=15..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:rabbit/brown"}
execute as @e[type=rabbit,scores={MobHeadDrops=16,MobHeadDrops=16..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:rabbit/white"}
execute as @e[type=rabbit,scores={MobHeadDrops=17,MobHeadDrops=17..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:rabbit/black"}
execute as @e[type=rabbit,scores={MobHeadDrops=18,MobHeadDrops=18..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:rabbit/blackandwhite"}
execute as @e[type=rabbit,scores={MobHeadDrops=19,MobHeadDrops=19..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:rabbit/gold"}
execute as @e[type=rabbit,scores={MobHeadDrops=20,MobHeadDrops=20..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:rabbit/saltandpepper"}
execute as @e[type=parrot,scores={MobHeadDrops=21,MobHeadDrops=21..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:parrot/red"}
execute as @e[type=parrot,scores={MobHeadDrops=22,MobHeadDrops=22..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:parrot/blue"}
execute as @e[type=parrot,scores={MobHeadDrops=23,MobHeadDrops=23..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:parrot/green"}
execute as @e[type=parrot,scores={MobHeadDrops=24,MobHeadDrops=24..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:parrot/cyan"}
execute as @e[type=parrot,scores={MobHeadDrops=25,MobHeadDrops=25..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:parrot/gray"}
execute as @e[type=horse,scores={MobHeadDrops=26,MobHeadDrops=26..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:horse/white"}
execute as @e[type=horse,scores={MobHeadDrops=27,MobHeadDrops=27..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:horse/creamy"}
execute as @e[type=horse,scores={MobHeadDrops=28,MobHeadDrops=28..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:horse/chestnut"}
execute as @e[type=horse,scores={MobHeadDrops=29,MobHeadDrops=29..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:horse/brown"}
execute as @e[type=horse,scores={MobHeadDrops=30,MobHeadDrops=30..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:horse/black"}
execute as @e[type=horse,scores={MobHeadDrops=31,MobHeadDrops=31..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:horse/gray"}
execute as @e[type=horse,scores={MobHeadDrops=32,MobHeadDrops=32..},tag=!loot] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:horse/dark_brown"}
execute as @e[tag=!loot1,type=rabbit,scores={MobHeadDrops=33,MobHeadDrops=33..}] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot1"],DeathLootTable:"mobs:rabbit/toast"}
execute as @e[tag=!loot,type=wither,scores={MobHeadDrops=34,MobHeadDrops=34..}] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:wither"}
execute as @e[tag=!loot,type=creeper,scores={MobHeadDrops=35,MobHeadDrops=35..}] at @s positioned ~ ~ ~ run data merge entity @s {Tags:["loot"],DeathLootTable:"mobs:chargedcreeper"}
